...
## Hardening Note (2026-03-31)

- 本文件中的 `P0/P1` 仅表示历史排序样例，不是正式漏洞状态、严重性或统计口径。
- lifecycle、formal finding 资格、候选链与 confirmed path 的边界以 `SKILL.md`、`agent.md` 和 `chain-synthesizer` 为准。
- 旧的 Kill Switch 说法只能作为“需要复核控制”的背景提示，不能替代真实代码语义判断。
